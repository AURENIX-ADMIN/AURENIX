...
"""
        ...
        print("Backup script patched with PGPASSWORD.")
...
if __name__ == "__main__":
    patch_backup("76.13.9.238", "root", r"0Vw&9k'l/yo+OS/IjbPE")
